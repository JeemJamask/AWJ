        ...
        <div className="home-page">
            <div className="div">
                <div className="overlap">
                    ...
                    <div className="text-wrapper-1">الأسئلة الشائعة</div>
                    <div className="text-wrapper-2">شركاؤنا</div>
                    <div className="text-wrapper-3">عن أوج</div>
                ...
                <div>
                    <div
                        className="overlap-4"
                        onMouseEnter={() => setHoveredImage("V1")}
                    ...
                    <div
                        className="overlap-6"
                        onMouseEnter={() => setHoveredImage("V2")}
                        onMouseLeave={() => setHoveredImage(null)}
                    >
                    ...
                    <div
                        className="overlap-7"
                        onMouseEnter={() => setHoveredImage("V3")}
                        onMouseLeave={() => setHoveredImage(null)}
                    >
